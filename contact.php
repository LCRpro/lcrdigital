...
$page_title = "Contact Agence Web" . city_phrase(" à ") . " – Devis Création Site Internet Gratuit | LCR DIGITAL";
$page_description = "Contactez LCR DIGITAL, votre agence web" . city_phrase(" à ") . ". Devis gratuit pour création de site internet, site vitrine, e-commerce ou application mobile. Réponse sous 24h.";
?>
        ...
        <div class="section banner-inner">
            <div class="hero-container">
                <div class="d-flex flex-column gspace-2">
                    <h2>Contact</h2>
                    <h1 class="banner-h1">Contact Agence Web<?= city_phrase(' à ') ?> – Devis Gratuit Création Site Internet</h1>
        ...
        <div class="section">
            <div class="hero-container">
                <div class="row row-cols-xl-2 row-cols-1 grid-spacer-2">
                    <div class="col">
                        <div class="contact-title animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                    ...
                    <div class="col">
                        <div class="contact-form-layout animate-box animated animate__animated" data-animate="animate__fadeInRight">
                            <?php if ($form_success): ?>
