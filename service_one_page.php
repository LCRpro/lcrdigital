...
<!DOCTYPE html>
<html lang="fr" data-title="Création site One Page<?= city_phrase(' à ') ?> – Solution rapide & efficace | LCR DIGITAL" data-description="Besoin d’un site One Page<?= city_phrase(' à ') ?> ? LCR DIGITAL crée des sites web modernes et performants pour présenter votre activité sur une seule page.">
<head>
    <meta charset="UTF-8">
