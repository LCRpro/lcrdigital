...
<!DOCTYPE html>
<html lang="fr" data-title="Création site catalogue<?= city_phrase(' à ') ?> – Présentez vos produits sans vente en ligne | LCR DIGITAL" data-description="Vous souhaitez présenter vos produits sans e-commerce ? Optez pour un site catalogue<?= city_phrase(' à ') ?>, conçu sur mesure par LCR DIGITAL.">
<head>
    <meta charset="UTF-8">
