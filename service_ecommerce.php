...
<!DOCTYPE html>
<html lang="fr" data-title="Création site e-commerce<?= city_phrase(' à ') ?> – Boutique en ligne performante | LCR DIGITAL" data-description="Lancez votre boutique en ligne<?= city_phrase(' à ') ?> avec LCR DIGITAL. Création de sites e-commerce sur mesure, UX optimisée et gestion facilitée.">
<head>
    <meta charset="UTF-8">
